    ...
    <div class="intro-y col-span-12 lg:col-span-8">
      <div class="lg:flex intro-y">
        <div class="relative">
          ...
          <SearchIcon class="w-4 h-4 absolute my-auto inset-y-0 mr-3 right-0 text-slate-500" />
        </div>
      ...
      <div class="grid grid-cols-12 gap-5 mt-5 pt-5 border-t">
        <a v-for="(faker, fakerKey) in $_.take($f(), 8)" :key="fakerKey" href="javascript:;"
          @click="addItemModal = true" class="intro-y block col-span-12 sm:col-span-4 2xl:col-span-3">
          <div class="box rounded-md p-3 relative zoom-in">
            <div class="flex-none relative block before:block before:w-full before:pt-[100%]">
              <div class="absolute top-0 left-0 w-full h-full image-fit">
                <img alt="Midone Tailwind HTML Admin Template" class="rounded-md" :src="faker.foods[0].image" />
              </div>
            </div>
      ...
      <TabPanels>
        <TabPanel>
          <div class="box p-2 mt-5">
            <a v-for="(faker, fakerKey) in $_.take($f(), 5)" :key="fakerKey" href="javascript:;"
    ...
    <ModalBody class="grid grid-cols-12 gap-4 gap-y-3">
      <div class="col-span-12">
        ...
        <div class="flex flex-1">
          ...
          <input id="pos-form-4" type="text" class="form-control w-24 text-center" placeholder="Item quantity"
            value="2" />
          <button type="button"
      ...
      <div class="col-span-12">
        ...
        <textarea id="pos-form-5" class="form-control" placeholder="Item notes"></textarea>
      </div>
    </ModalBody>
    <ModalFooter class="text-right">
