    ...
    >
      <div class="intro-y box mt-5">
        ...
        <div class="p-5 border-t border-slate-200/60 dark:border-darkmode-400">
          ...
          <a class="flex items-center mt-5" href="#display">
            <BoxIcon class="w-4 h-4 mr-2" /> Account Settings
          </a>
          <a class="flex items-center mt-5" href="/change-password">
...
10 Anson Road, International Plaza, #10-11, 079903 Singapore, Singapore</textarea
      ...
      <div class="intro-y box mt-5">
        <div
          class="flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400"
        >
          <h2 class="font-medium text-base mr-auto" id="display">Personal Information</h2>
        </div>
        <div class="p-5">
          <div class="grid grid-cols-12 gap-x-5">
