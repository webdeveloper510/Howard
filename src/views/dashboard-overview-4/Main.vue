        ...
        <div class="col-span-12 xl:col-span-9 mt-8">
          ...
          <div class="report-box-2 intro-y mt-5">
            <div class="box grid grid-cols-12">
              <div
                class="col-span-12 lg:col-span-4 px-8 py-12 flex flex-col justify-center"
              >
                <PieChartIcon class="w-10 h-10 text-pending" />
                <div
                  class="justify-start flex items-center text-slate-600 dark:text-slate-300 mt-12"
                >
                  My Total Assets
                  <AlertCircleIcon
              ...
              >
                <TabGroup>
                  <TabList
                    class="nav-pills w-60 border border-slate-300 dark:border-darkmode-300 border-dashed rounded-md mx-auto p-1 mb-8"
                  >
            ...
            <div class="flex items-center mb-5">
              <div class="flex items-center">
                ...
                <div
                  ...
                  title="49% Higher than last month"
                >
                  5% <ChevronUpIcon class="w-4 h-4 ml-0.5" />
                </div>
              </div>
            ...
            <div class="flex items-center mb-5">
              <div class="flex items-center">
                ...
                <div
                  ...
                  title="49% Higher than last month"
                >
                  -9% <ChevronDownIcon class="w-4 h-4 ml-0.5" />
                </div>
              </div>
