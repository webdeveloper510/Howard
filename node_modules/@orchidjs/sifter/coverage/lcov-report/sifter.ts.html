...
<head>
    <title>Code coverage report for sifter.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> sifter.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">95.92% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>141/147</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>133/138</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3916x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3906x</span>
<span class="cline-any cline-yes">3906x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3906x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3916x</span>
<span class="cline-any cline-yes">3915x</span>
<span class="cline-any cline-yes">3915x</span>
<span class="cline-any cline-yes">3915x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3915x</span>
...
&nbsp;
			if( word.length &gt; 0 ){
				...
				<span class="missing-if-branch" title="else path not taken" >E</span>if( this.settings.diacritics ){
...
&nbsp;
		if (!token_count) {
			return <span class="fstat-no" title="function not covered" >function() {</span> <span class="cstat-no" title="statement not covered" >return 0</span>; };
		}
&nbsp;
...
&nbsp;
	 ...
	 * @return function(a,b)
	 */
<span class="fstat-no" title="function not covered" >	getSortFunction(</span>query:string, options:T.Options) {
		var search  = <span class="cstat-no" title="statement not covered" >this.p</span>repareSearch(query, options);
<span class="cstat-no" title="statement not covered" >		return t</span>his._getSortFunction(search);
	}
&nbsp;
...
&nbsp;
		...
		if (sort) {
			for (i = 0, n = sort.length; i &lt; n; i++) {
				<span class="missing-if-branch" title="else path not taken" >E</span>if (search.query || sort[i].field !== '$score') {
...
&nbsp;
		...
		if (search.query) {
			...
			for (i = 0, n = sort_flds.length; i &lt; n; i++) {
				<span class="missing-if-branch" title="if path not taken" >I</span>if (sort_flds[i].field === '$score') {
<span class="cstat-no" title="statement not covered" >					sort_flds.</span>splice(i, 1);
...
&nbsp;
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if (!sort_flds_count) {
...
&nbsp;
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if (fn_sort) search.items.sort(fn_sort);
&nbsp;
		// apply limits
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Aug 24 2021 16:53:56 GMT-0600 (Mountain Daylight Time)
            </div>
        </div>
